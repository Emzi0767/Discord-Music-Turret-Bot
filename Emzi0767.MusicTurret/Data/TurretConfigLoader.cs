...
namespace Emzi0767.MusicTurret.Data
{
    ...
    /// </summary>
    public sealed class TurretConfigLoader
    {
        /// <summary>
        ...
        public async Task<TurretConfig> LoadConfigurationAsync(FileInfo file)
        {
            ...
            using (var sr = new StreamReader(fs, TurretUtilities.UTF8))
                json = await sr.ReadToEndAsync().ConfigureAwait(false);

            // deserialize the config
            return JsonConvert.DeserializeObject<TurretConfig>(json);
        }
        ...
        public void ValidateConfiguration(TurretConfig config)
        {
            // validate the config
